...
import 'package:whatsapp/pages/image_picker_page.dart';
...
import 'package:whatsapp/widgets/short_h_bar.dart';
...
class _UserInfoPageState extends ConsumerState<UserInfoPage> {
  ...
  saveUserDataToFirebase() {
    ...
    if (username.isEmpty) {
      ...
      return showAlertDialog(
        context: context,
        message: "the name length must be between 3 ~ 20",
      );
    }
    ...
    return Column(
      children: [
        CustomIconButton(
          onTap: onTap,
          icon: icon,
          iconColor: ColorPalette.greenDark,
          minWidth: 50,
          border: Border.all(
