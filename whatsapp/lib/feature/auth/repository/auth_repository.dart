...
import 'package:whatsapp/common/utils/firebase_storage_repository.dart';
import 'package:whatsapp/common/utils/show_alert_dialog.dart';
import 'package:whatsapp/common/utils/show_loading_dialog.dart';
...
class AuthRepository {
  ...
  void sendSmsCode({
    ...
    try {
      showLoadingDialog(
        context: context,
        message: "Sedning a verification code to $phoneNumber",
      );
